...
FLAGS = -Wall -Wextra -I. -I./appTimer -I./simulateLED
DEBUG_FLAGS = -g

SOURCES = main appTimer/appTimer simulateLED/simulateLED

dirs:
	@mkdir -p $(RELEASE_DIR)
	@mkdir -p $(RELEASE_DIR)/appTimer
	@mkdir -p $(RELEASE_DIR)/simulateLED
...
rpi: dirs
	$(CROSS_CC) $(FLAGS) $(APP_SRC) -o $(EXEC_RPI)
	@$(foreach file, $(SOURCES), \
